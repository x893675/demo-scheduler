module github.com/x893675/demo-scheduler
...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.23.8-rc.0
...
replace k8s.io/code-generator => k8s.io/code-generator v0.23.8-rc.0
...
replace k8s.io/cri-api => k8s.io/cri-api v0.23.8-rc.0
...
replace k8s.io/mount-utils => k8s.io/mount-utils v0.23.8-rc.0
